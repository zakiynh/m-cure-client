    ...
    <>
      <ScrollView>
        <View style={styles.container}>
          ...
          <View
            style={tailwind(`bg-[#b4e197] w-80 h-2/5 rounded-3xl mx-auto pb-8`)}
          >
            <TextInput
              style={tailwind(
                `w-3/4 h-12 mx-auto mt-7 px-4 rounded-2xl bg-[#f3f3f3] text-xl`
              )}
            ...
            <TextInput
              style={tailwind(
                `w-3/4 h-12 mx-auto my-4 px-4 rounded-2xl bg-[#f3f3f3] text-xl`
              )}
            ...
            <Pressable
              style={tailwind(
                `bg-[#e9efc0] h-12 w-3/4 mx-auto my-4 px-4 rounded-2xl`
              )}
              onPress={loginHandler}
            >
              <Text style={tailwind("text-xl text-center my-auto font-bold")}>
                Login
              </Text>
            </Pressable>
          </View>
